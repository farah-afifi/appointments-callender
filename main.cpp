...
int main()
{
    ...
    cout<<"please enter the appointments of your calendar\n";
    ...
    while (true){
        ...
        if(choice == '1'){
            int tempN;
            cout << "write the number of the day you want to add the appointment to: " << endl;
            cin >> tempN;
            ...
            int tempN;
            cout << "write the number of the day you want to delete the appointmeent from: " << endl;
            cin >> tempN;
            Appointment newAppoint;
            cin >> newAppoint;

            DayAppointments day = TimeTable[tempN-1];
            TimeTable.removeAppointment(day , newAppoint);
        }
        else if(choice == '3'){
            int tempN;
            cout << "write the number of the day you want to display the appointments from : " << endl;
            cin >> tempN;
            ...
            int tempN , tempN2;
            cout << "write the number of the two days you want to check if they are equal or not : " << endl;
            cin >> tempN >> tempN2;
